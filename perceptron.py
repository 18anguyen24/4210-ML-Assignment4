...
# SPECIFICATION: simulate grid search in a MLP model to get the best accuracy
    ...
    for b in r: #iterates over r
        ...
        for a in range(2): #iterates over the algorithms
            ...
            if acc > highest_accuracy:
                ...
                print("Highest Perceptron accuracy so far: " + str(highest_accuracy) + ", Parameters: learning rate=" + str(n_val) + ", shuffle=" + str(r_val))
